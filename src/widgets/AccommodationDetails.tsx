    ...
    return (
        <div className="w-full py-4 ">
            ...
            <ul className="flex gap-2">
                ...
                <li>&middot;</li>
                <li className="hover:underline">5 quartos</li>
                <li>&middot;</li>
                <li className="hover:underline">5 camas</li>
                <li>&middot;</li>
                <li className="hover:underline">6 banheiros</li>
            </ul>

            <h2 className="pt-4 text-2xl font-semibold">O que esse lugar oferece?</h2>
